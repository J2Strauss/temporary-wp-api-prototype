...
class OPanda_SocialOptionsMetaBox extends FactoryMetaboxes321_FormMetabox
{
    ...
    public function configure( $scripts, $styles) {
         $styles->add( BIZPANDA_SOCIAL_LOCKER_URL . '/admin/assets/css/social-options.010002.css');  
         $scripts->add( BIZPANDA_SOCIAL_LOCKER_URL . '/admin/assets/js/social-options.010002.js');
    }
